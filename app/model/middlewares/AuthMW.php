...
class AuthMW
{
    ...
    {        
        ...
        elseif( isset(USER_RIGHTS[$userType][$action]) && in_array($object, USER_RIGHTS[$userType][$action]) ) // ... o si tiene el derecho, y tiene el derecho sobre ese tipo de objetos ...
        {            
            if( $action == 'modificar' )
            {
